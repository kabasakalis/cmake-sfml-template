...
let g:build_debug_command = "cd " . g:build_debug_folder . " && sh ..\\tasks\\cmake_build.sh "
let g:build_release_command = "cd " . g:build_release_folder . " && sh ../tasks/cmake_build.sh "


let g:build_run_debug_command =  g:build_debug_command . g:run_debug_command 
let g:build_run_release_command =  g:build_release_command . g:run_release_command 
...
call SpaceVim#mapping#space#langSPC('nmap', ['l','b', 'b'], 
       \ 'call plugin#cpprunner#open("build_run_release_command")', 'Build release', 1)
