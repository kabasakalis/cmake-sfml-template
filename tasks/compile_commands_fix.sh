#!/bin/sh
echo Fixing compile_commands.json and moving it to project root  # See caveat on windows: https://github.com/MaskRay/ccls/wiki/compile_commands.json
# We are assuming root project contains a build directory 
